...
<body>
	...
	<h2>The films may be fake, but you'll wish they weren't!</h2>
	<h3>Menu</h3>
...
<section>
	...
	<div class="container"
		...
		<button type="button" name="btnlookup" id="btnlookup"
			data-toggle="modal" data-target="#myModal2"
			class="btn btn-primary mb-3">Film Look Up</button>
		...
		<div id="myModal2" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form class="form-horizontal" role="" method="GET"
						action="lookup.do">
...
//
		...
		<button type="button" name="btnFilm" data-toggle="modal"
			data-target="#myModal" class="btn btn-primary mb-3">Add
			Film</button>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form class="form-horizontal" role="" method="POST" action="add.do">
						...
						<div class="modal-body">
							<div class="form-group">
								<label for="inputName" class="form-label">Release Year</label> <input
									type="number" class="form-control" name="releaseYear"
